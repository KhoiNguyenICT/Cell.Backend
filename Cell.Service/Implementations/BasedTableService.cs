...
{
    public interface IBasedTableService
    {
        Task<string> CreateBasedTable(CreateBasedTableModel model);
    ...
    public class BasedTableService : IBasedTableService
    {
        private readonly AppDbContext _context;
        private readonly string _connectionString;

        public BasedTableService(AppDbContext context, IConfiguration configuration)
        {
            _context = context;
            _connectionString = configuration.GetConnectionString(ConfigurationKeys.DefaultConnection);
        }

        public async Task<string> CreateBasedTable(CreateBasedTableModel model)
        {
